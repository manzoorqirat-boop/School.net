        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_fee_invoices_no_stored_overdue", "status <> 'overdue'::invoice_status");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_classes = table.Column<List<string>>(type: "text[]", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_notices_priority", "priority IN ('normal', 'important', 'urgent')");
                    table.CheckConstraint("ck_notices_target_roles", "target_roles <@ ARRAY['parent','teacher','student','school_admin','principal','accountant']::text[]");
                    table.CheckConstraint("ck_notices_window", "expires_at IS NULL OR publish_at IS NULL OR expires_at > publish_at");
                    table.ForeignKey(
                        name: "fk_notices_users_created_by_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_device_tokens_school_user",
                table: "device_tokens",
                columns: new[] { "school_id", "user_id", "is_revoked" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_notices_created_by_user_id",
                table: "notices",
                column: "created_by_user_id");

            migrationBuilder.CreateIndex(
                name: "ix_notices_school_pinned_time",
                table: "notices",
                columns: new[] { "school_id", "is_pinned", "created_at" },
                descending: new[] { false, true, true });

            migrationBuilder.CreateIndex(
                name: "ix_notices_target_classes",
                table: "notices",
                column: "target_classes")
                .Annotation("Npgsql:IndexMethod", "gin");

            migrationBuilder.CreateIndex(
                name: "ix_notices_target_roles",
                table: "notices",
                column: "target_roles")
                .Annotation("Npgsql:IndexMethod", "gin");
